...
Draw a line on the LCD
	GLCD_Line (U8 x1,U8 y1,U8 x2,U8 y2)
		u8Xaxis1 = absciss begining (in pixels)
		u8Yaxis1 = ordinate begining (in pixels)
		u8Xaxis2 = absciss end (in pixels)
		u8Yaxis2 = ordinate end (in pixels)
-------------------------------------------------------------------------------*/
